...
public class StormyModifierConfig {
    ...
    public static void init(){
        ...
        stormyModifierConfig.addDefault("stormy_show_lighting_damage_message", true);
        ...
        stormyModifierConfig.addDefault("stormy_only_spawn_when_storming", false);
        List<String> commandDescription = new ArrayList<>();
        commandDescription.add(ChatColor.YELLOW + "적이 {stormy_lighting_range}블록 이내에 있다면,");
        commandDescription.add(ChatColor.YELLOW + "{stormy_lighting_cooldown}틱 마다 번개 소환 + {stormy_lighting_damage}만큼의 대미지를 준다.");
