...
public class HealthyAbility extends Ability {
    ...
    public HealthyAbility(@NotNull NamespacedKey id, @Nullable Component symbol, @NotNull Component name, @Nullable FileConfiguration abilityConfig, @Nullable TextColor displayColor) {
    ...
    public void onSpawn(Monster monster){
        ...
        monster.getAttribute(Attribute.MAX_HEALTH).setBaseValue(monster.getAttribute(Attribute.MAX_HEALTH).getBaseValue() * amount);
